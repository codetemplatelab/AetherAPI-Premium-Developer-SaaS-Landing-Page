    ...
    <section id="features" className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          >
            Built for the <span className="text-emerald-500">Modern Developer</span>
          </motion.h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            Everything you need to build production-grade APIs without the infrastructure headache.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURES.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group relative p-8 bg-slate-900/50 border border-white/10 rounded-3xl hover:border-emerald-500/50 transition-all"
            >
